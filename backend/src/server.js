...
const settlementProfileRoutes = require('./routes/settlementProfiles');
const paymentRouterRoutes = require('./routes/paymentRouter');
...
const { ensureSettlementSchema } = require('./services/settlementProfiles');
const { ensurePaymentRouterSchema } = require('./services/paymentRouter');
...
app.use('/api/settings/mpesa', mpesaSettingsRoutes);
app.use('/api/settings', settingsRoutes);
app.use('/api/settlements', settlementProfileRoutes);
app.use('/api/payment-router', paymentRouterRoutes);
...
app.listen(PORT, HOST, () => {
  ...
  ensureSettlementSchema().then(() => console.log('ISP settlement schema ready.')).catch((error) => console.error('ISP settlement schema initialization failed:', error.message));
  ensurePaymentRouterSchema().then(() => console.log('Payment router schema ready.')).catch((error) => console.error('Payment router schema initialization failed:', error.message));
