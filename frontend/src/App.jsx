...
import BillingSignup from './pages/BillingSignup';
...
const BillingWorkspace = lazy(() => import('./pages/BillingWorkspaceWithCrm'));
const AgentPortal = lazy(() => import('./pages/AgentPortal'));
const PppoePortal = lazy(() => import('./pages/PppoePortal'));
const PppoeExpiredPaywall = lazy(() => import('./pages/PppoeExpiredPaywall'));
