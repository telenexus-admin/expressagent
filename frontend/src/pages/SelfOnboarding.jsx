...
function NexaLogo() {
  return <div className="flex items-center gap-2"><div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-[#3535FF] shadow-lg"><svg viewBox="0 0 24 24" className="h-6 w-6" fill="none"><path d="M5 19V5l14 14V5" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" /></svg></div><div><p className="text-base font-black text-white">Nexa</p><p className="text-[10px] font-bold tracking-widest text-white/45">BY TELENEXUS</p></div></div>;
}
...
export default function SelfOnboarding() {
  ...
  if (stage === 'qr') {
    ...
    return <div className="min-h-screen bg-[#F6F7FF] px-5 py-6"><div className="mx-auto max-w-md"><div className="mb-7 flex items-center justify-between"><div className="flex items-center gap-2"><div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#101027] text-white font-black">N</div><span className="font-black text-slate-950">Nexa</span></div><span className="rounded-full bg-[#E9E9FF] px-4 py-2 text-xs font-black text-[#3535FF]">Step 2 of 2</span></div><div className="rounded-[34px] bg-white p-6 text-center shadow-xl shadow-indigo-100/70"><h1 className="text-2xl font-black text-slate-950">Connect WhatsApp</h1>
      {connectMethod === 'qr' ? <>
